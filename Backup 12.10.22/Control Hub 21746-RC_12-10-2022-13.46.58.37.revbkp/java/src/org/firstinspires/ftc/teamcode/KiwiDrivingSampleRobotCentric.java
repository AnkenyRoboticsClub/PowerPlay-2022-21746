...
@TeleOp(name = "KiwiDrivingSample (Robot Centric)")
public class KiwiDrivingSampleRobotCentric extends LinearOpMode {
    ...
    static final double LEFT_MOTOR_ANGLE_RAD = 4 * Math.PI / 3;
    static final double RIGHT_MOTOR_ANGLE_RAD = 0;
    static final double SLIDE_MOTOR_ANGLE_RAD = 2 * Math.PI / 3;
